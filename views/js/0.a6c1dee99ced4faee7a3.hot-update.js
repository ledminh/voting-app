	...
	var MyPage = function (_Page) {
	  ...
	  _createClass(MyPage, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (nextProps.data.username && nextProps.data.username !== this.props.data.username || nextProps.data.votes_id !== this.props.data.votes_id) {
	        this.state.data = {
	          username: nextProps.data.username,
	          photo: nextProps.data.photo,
	          num_vote: nextProps.data.votes_id.length
	        };
