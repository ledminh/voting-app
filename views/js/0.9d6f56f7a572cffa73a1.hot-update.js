...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (dataset) {
	  var dataset = [{ option: 'Abulia', num_votes: 10 }, { option: 'Betelgeuse', num_votes: 20 }, { option: 'Cantaloupe', num_votes: 30 }, { option: 'Dijkstra', num_votes: 40 }];
	  ...
	  var svg = d3.select('.graph_wrapper').append('svg').attr('width', width).attr('height', height).append('g').attr('transform', 'translate(' + width / 2 + ',' + height / 2 + ')');
	  ...
	  path.on('mouseover', function (d) {
	    tooltip.select('.label').html(d.data.option);
