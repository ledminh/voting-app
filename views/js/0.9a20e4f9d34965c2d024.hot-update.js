	...
	var MyPage = function (_Page) {
	  ...
	  _createClass(MyPage, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (nextProps.data.username && nextProps.data.username !== this.props.data.username || nextProps.data.num_vote !== this.props.data.num_vote || nextProps.data.polls !== this.props.data.polls) {
	        this.state.data = {
