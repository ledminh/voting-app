...
/***/ function(module, exports, __webpack_require__) {
	...
	var _add_poll = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./sections/add_poll.jsx\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var Main = function (_React$Component) {
	  ...
	  _createClass(Main, [{
	    ...
	    value: function show(page) {
	      ...
	      var prev_page = "HomePage";

	      if (this.state.current_page !== "") prev_page = this.state.current_page;
