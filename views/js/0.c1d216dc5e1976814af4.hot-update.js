...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (dataset) {
	  ...
	  var svg = d3.select('.graph_wrapper').remove();

	  svg = d3.select('.graph_wrapper').append('svg').attr('width', width).attr('height', height).append('g').attr('transform', 'translate(' + width / 2 + ',' + height / 2 + ')');
