...
/***/ function(module, exports, __webpack_require__) {
	...
	var _graph_machine = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../machines/graph_machine.jsx\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var A_Poll = function (_Page) {
	  ...
	  _createClass(A_Poll, [{
	    ...
	    value: function addVote() {
	      if (this.state.chosen !== "") this.props.loadData("Voting", [this.state.chosen, this.props.data.id]);else {
	    ...
	    value: function selectHandler(event) {
	      if (event.target.value !== "Make a choice ...") this.state.chosen = event.target.value;else {
	        this.state.chosen = "";
	      }
	    }
	  }, {
