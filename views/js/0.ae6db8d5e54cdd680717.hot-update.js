	...
	var MyPage = function (_Page) {
	  ...
	  _createClass(MyPage, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (nextProps.data.username && nextProps.data.username !== this.props.data.username || nextProps.data.num_polls !== this.props.data.num_polls) {
	        this.state.data = {
	    ...
	    value: function hide(yes) {
	      if (yes) {
	        ...
	        console.log(this.props.data.my_polls);
	        this.setState({
	          display: ""
	        });
	      }
