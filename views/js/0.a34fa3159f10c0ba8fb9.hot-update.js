	...
	var MyPage = function (_Page) {
	  ...
	  _createClass(MyPage, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (nextProps.data.username && nextProps.data.username !== this.props.data.username || nextProps.data.num_vote !== this.props.data.num_vote || nextProps.data.poll_tabs !== this.props.data.poll_tabs) {
	        this.state.data = {
	          username: nextProps.data.username,
	          photo: nextProps.data.photo,
	          num_vote: nextProps.data.num_vote,
	          poll_tabs: nextProps.data.poll_tabs
	        };
	        this.forceUpdate();
	      }
	    }
